import{j as e}from"./157a8d2c782d6421.js";const x=({label:r,error:s,onChange:o,containerClassName:d="",className:a="",type:n="text",id:c,required:i,...l})=>{const t=c||(r?`input-${r.toLowerCase().replace(/\s+/g,"-")}`:void 0),m=`
